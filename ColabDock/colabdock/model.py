...
class ColabDock(_dock, _rank, _rest):
    ...
    def setup(self):
        ...
        #print(self.rest_num)
        #print(self.rest_set)
        #print(self.rest_set['rest_p']['MvN'].shape)
        #print(self.rest_set['rest_p']['non'].shape)
        #print(self.rest_set['rest_mask']['MvN'].shape)
        #print(self.rest_set['rest_mask']['non'].shape)
        #np.savetxt('rest_p_MvN.out', self.rest_set['rest_p']['MvN'], delimiter=',')
        #np.savetxt('rest_p_non.out', self.rest_set['rest_p']['non'], delimiter=',')
        #np.savetxt('rest_mask_MvN_0.out', self.rest_set['rest_mask']['MvN'][0], delimiter=',')
        #np.savetxt('rest_mask_MvN_1.out', self.rest_set['rest_mask']['MvN'][1], delimiter=',')
        #np.savetxt('rest_mask_MvN_2.out', self.rest_set['rest_mask']['MvN'][2], delimiter=',')
        #np.savetxt('rest_mask_non.out', self.rest_set['rest_mask']['non'], delimiter=',')

        # initial colabdesign
        _dock.__init__(self)
        print('Fixed chains self.asym_id:')
        print(self.asym_id)

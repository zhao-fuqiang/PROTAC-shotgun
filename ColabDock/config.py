...
config = {
    ...
    'save_path': './8QW7/PROTAC_8QW7_results/FFT_cluster_X',

    ###########################################################################################################
    # template and native structure
    ###########################################################################################################
    # the structure of proteins you want to dock
    'template': './8QW7/PROTAC_8QW7_results/FFT_pocket/POI_and_E3_cluster_X.pdb',
    ...
    ###########################################################################################################
    # AF2 weights dir
    'data_dir': '/home/user/project_PROTAC/ColabDock-main/params',

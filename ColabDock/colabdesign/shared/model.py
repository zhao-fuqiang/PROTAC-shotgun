  ...
  def set_seq(self, seq=None, mode=None, bias=None, rm_aa=None, **kwargs):
    ...
    if seq_init is not None:
      ...
      if isinstance(seq_init,list) and seq_init[0] in modes:
        ...
        seq = seq_init
    print('seq_init 0 in shared model.py:')
    print(seq_init)
    print('seq 0 in shared model.py:')
    print(seq)
    print('mode in shared model.py:')
    print(mode)
    ...
    if "wildtype" in mode or "wt" in mode:
      ...
      if "pos" in self.opt:
        ...
        seq = wt_seq
    print('seq 1 in shared model.py:')
    print(seq)
    ...
    if "gumbel" in mode:
      ...
      if "soft" in mode:
        ...
        x = x + x_gumbel
      print('x 2 in shared model.py:')
      print(x)

    print('x 3 in shared model.py:')
    print(x)
    self.params["seq"] = x

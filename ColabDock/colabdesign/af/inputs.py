...
class _af_inputs:
  ...
  def _update_template_mask(self, inputs, opt, key, step_iter):
    ''''dynamically update template mask'''
    ...
    if self.use_dgram:
      ...
      #print('step_iter:')
      #print(step_iter)
      #print('template_dgram 0:')
      #print(template_dgram.shape)
      #print(template_dgram)

      template_mask_2d = self._batch['mask_dgram']
      template_mask_2d_allone = jnp.ones_like(template_mask_2d)
      if step_iter < 3:
        template_mask_2d = template_mask_2d_allone
      template_dgram = template_dgram * template_mask_2d[..., None]
      #print('template_mask_2d 0:')
      #print(template_mask_2d.shape)
      #print(template_mask_2d)
  ...
  def _update_template(self, inputs, opt, key):
    ...
    #print(self._batch["all_atom_positions"].shape)
    #print(self._batch["all_atom_positions"])
    #print("all_atom_mask:")
    #print(self._batch["all_atom_mask"].shape)
    #print(self._batch["all_atom_mask"])
    #print("pb_mask:")
    #print(pb)
    #print(pb_mask)
    ...
    if self.use_dgram:
      ...
      im0 = ax[0].imshow(template_dgram[n_offset + 0], origin='upper')
      im1 = ax[1].imshow(template_dgram[n_offset + 1], origin='upper')
      im2 = ax[2].imshow(template_dgram[n_offset + 2], origin='upper')
      im3 = ax[3].imshow(template_dgram[n_offset + 3], origin='upper')
      im4 = ax[4].imshow(template_dgram[n_offset + 4], origin='upper')
      im5 = ax[5].imshow(template_dgram[n_offset + 5], origin='upper')
      # add residue ID labels to axes
      tick_interval = 20
      plt.title('template_dgram')
      # colorbar
      cbar0 = fig.colorbar(im0, ax=ax[0])
      cbar0.ax.set_ylabel('template_dgram')
      cbar1 = fig.colorbar(im1, ax=ax[1])
      cbar1.ax.set_ylabel('template_dgram')
      cbar2 = fig.colorbar(im2, ax=ax[2])
      cbar2.ax.set_ylabel('template_dgram')
      cbar3 = fig.colorbar(im3, ax=ax[3])
      cbar3.ax.set_ylabel('template_dgram')
      cbar4 = fig.colorbar(im4, ax=ax[4])
      cbar4.ax.set_ylabel('template_dgram')
      cbar5 = fig.colorbar(im5, ax=ax[5])
      cbar5.ax.set_ylabel('template_dgram')
      plt.savefig('template_dgram.png')
      '''
      ...
      #print('template_dgram 1:')
      #print(template_dgram)
      #print('template_mask_2d 1:')
      #print(template_mask_2d.shape)
      #print(template_mask_2d)
      #print(template_mask_2d[..., None].shape)
      #print(template_mask_2d[..., None])

      #fig, ax = plt.subplots(1, 2, figsize=(40, 20))
      #im0 = ax[0].imshow(template_mask_2d, origin='upper')
      # add residue ID labels to axes
      #tick_interval = 20
      #plt.title('template_mask_2d')
      # colorbar
      #cbar0 = fig.colorbar(im0, ax=ax[0])
      #cbar0.ax.set_ylabel('template_mask_2d')
      #plt.savefig('template_mask_2d.png')

      dgram_mask = jax.random.bernoulli(key, 1-opt["template"]["dropout"],(L,L))

      #print('dgram_mask 0:')
      #print(dgram_mask.shape)
      #print(dgram_mask)
      #print('opt 0:')
      #print(opt)
      #print('key 0:')
    ...
    #print('template_all_atom_positions:')
    #print(inputs['template_all_atom_positions'].shape)
    #print(inputs['template_all_atom_positions'])
    #print('template_all_atom_mask:')
    #print(inputs['template_all_atom_mask'].shape)
    #print(inputs['template_all_atom_mask'])
  ...
  def _update_template_complex(self, inputs, atom_position, atom_mask):
    ...
    #print('atom_position in inputs.py:')
    #print(atom_position.shape)
    #print(atom_position)
    #print('atom_mask in inputs.py:')
    #print(atom_mask.shape)
    #print(atom_mask)
    pb, pb_mask = model.modules.pseudo_beta_fn(self._wt_aatype,
                                               atom_position,
                                               atom_mask)
    #print('pb in inputs.py:')
    #print(pb.shape)
    #print(pb)
    #print('pb_mask in inputs.py:')
    #print(pb_mask.shape)
    #print(pb_mask)
    if self.use_dgram:
      #print('use dgram in input.py')
      template_dgram = model.modules.dgram_from_positions(pb, **self._runner.config.model.embeddings_and_evoformer.template.dgram_features)
      ...
      #print('not use dgram in input.py')
    ...
    #print('template_dgram in inputs.py:')
    #print(template_dgram.shape)
    #print(template_dgram)
